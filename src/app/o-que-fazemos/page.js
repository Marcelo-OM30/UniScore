...
export default function OQueFazemos() {
    return (
        <div className="min-h-screen bg-[#fffbe6] font-sans flex flex-col items-center justify-center p-8">
            <div className="max-w-2xl w-full bg-[#c6ffe0] rounded-3xl shadow-lg p-8 mb-8 flex flex-col items-center">
                <h1 className="text-3xl font-bold mb-4 text-gray-900">O que fazemos</h1>
                <p className="text-lg text-gray-800 mb-6 text-center">A UniScore é uma plataforma aberta para avaliação de eventos universitários. Nosso objetivo é promover transparência, confiança e engajamento entre estudantes, familiares e visitantes, permitindo que todos compartilhem opiniões, notas e experiências sobre eventos promovidos por universidades.</p>
                <p className="text-md text-gray-700 mb-6 text-center">Aqui você pode avaliar eventos, debater, ganhar selos e estrelas por participação, e ajudar universidades a aprimorar seus serviços. Junte-se à nossa comunidade e faça parte da transformação universitária!</p>
